    ...
    return (
        <div>
            ...
            <div className='px-8 box-border'>
                ...
                <div>
                    {
                        loading === true ? <Loading></Loading> : allApps.length === 0 ? <AppsNotFound></AppsNotFound> : <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center justify-center gap-6'>
